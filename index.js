// prompts.js
// TO ADD A NEW PROMPT: Copy one block inside the brackets {}, paste it, and change the details.
...
const allPrompts = [
    ...
    {
        id: 4,
        image: "https://i.postimg.cc/59srh3ms/Gemini-Generated-Image-31ovid31ovid31ov.png",
        prompt: "Danielle from NewJeans, standing casually in a tranquil snowy landscape, wearing relaxed  Perfect lighting highlights Danielle's features, ensuring she harmonizes with the peaceful natural environment, creating an inviting and warm atmosphere amidst the cold. 4:5.",
        category: "nanobanana"  // <--- ADD THIS
    }
];
